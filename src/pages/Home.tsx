      ...
      <section className="financial-tools-section">
        <div className="container">
          ...
          <div className="tools-image-container">
            <img 
              src={toolsImage} 
              alt="Financial Tools Illustration"
              className="tools-illustration"
            />
          </div>
        </div>
      </section>
              ...
              <div key={index} className="testimonial-card">
                <div className="testimonial-header">
                  ...
                  <div className="testimonial-info">
                    <div className="testimonial-name">Customer Name</div>
                    <div className="testimonial-type">Loan Type</div>
                  </div>
                </div>
                <p>
                  "The process was incredibly smooth and efficient. I got multiple offers within minutes and was able to choose the best one for my needs."
                </p>
              </div>
            ))}
          </div>
